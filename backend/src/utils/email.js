        ...
        const mailOptions = {
            ...
            html: `
                <div style="border: 1px solid #ddd; padding: 20px; max-width: 400px; margin: 0 auto;">
                    ...
                    <div style="background: #ddd; padding: 15px; border-radius: 8px; text-align: center;">
                        <h3>合計金額</h3>
                    ...
                    <div style="text-align: center; margin: 20px 0;">
                        <img src="cid:${qrCodeContentId}" width="300" />
                    </div>

                    <div style="background: #f8f9fa; padding: 15px; border-radius: 6px;">
                        <p><strong>${config.store_name}</strong></p>
                        <p>open ${config.open_hour}</p>
                        <p>TEL: ${config.tel}</p>
                    </div>
                </div>
            `,
